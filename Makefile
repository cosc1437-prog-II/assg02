...
${OBJ_DIR}/assg02-library.o: ${SRC_DIR}/assg02-library.cpp ${INC_DIR}/assg02-library.hpp
${OBJ_DIR}/${PROJECT_NAME}-tests.o: ${SRC_DIR}/${PROJECT_NAME}-tests.cpp ${INC_DIR}/assg02-library.hpp
